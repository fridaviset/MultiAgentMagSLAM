function [x_hat,q_hat,m,P]=Algorithm2PlotIntermediateMaps(delta_x,delta_q,y,Lambda,x_0,q_0,sigma_y,sigma_p,sigma_q,n,xl,xu,yl,yu,zl,zu,Indices,alpha,N_comm,PhiVec,X,Y,marg)
